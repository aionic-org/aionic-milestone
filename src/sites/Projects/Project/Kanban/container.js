...
class SitesProjectKanbanContainer extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<div className="SitesProjectKanbanContainer">
				<SitesProjectKanban project={project} />
			</div>
		);
	}
}

export default withRouter(SitesProjectKanbanContainer);
